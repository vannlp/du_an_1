            ...
            <div class="listNew__khung">
                <form action="?c=tin_tuc&a=index" enctype="multipart/form-data" method="post" class="tinTuc-wrapper">
                    <div class="form-group">
                        ...
                        <input type="text" required placeholder="Title bài viết" name="title" id="title" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="anh">Ảnh đại diện</label>
                        <input type="file" required name="anh" id="anh" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="noiDung" required placeholder="Nhập nội dung vào đây" id="noiDung" class="form-control" cols="30" rows="10"></textarea>
                    </div>
                    <script>
