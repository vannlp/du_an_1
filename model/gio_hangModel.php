...
class gio_hangModel extends DB
{
    ...
    function update_giohang($id_sanpham, $so_luong, $ten_dang_nhap, $tong_tien){
        $sql = "UPDATE gio_hang SET so_luong = $so_luong,
                                    tong_tien = $tong_tien,
                WHERE ten_dang_nhap = '$ten_dang_nhap' AND id_sanpham = $id_sanpham";
        return $this->setData($sql);
    }
